...
async def uploadtoazure(file: UploadFile,file_name: str,file_type:str):
    connect_str = "DefaultEndpointsProtocol=https;AccountName=azureretopy;AccountKey=u4uQgkF/5FL2rcwv9vW29a12goE03IzXSEY1yhoowdtDBZT0JYRAjhmiBT+oHtVWC44H7nDqa3w0+AStVfQe4Q==;EndpointSuffix=core.windows.net"
